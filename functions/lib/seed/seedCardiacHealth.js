...
exports.seedCardiacHealth = seedCardiacHealth;
exports.clearCardiacHealth = clearCardiacHealth;
const firestore_1 = require("firebase-admin/firestore");
/**
 * Generate blood pressure trend data (last 30 days)
 * Simulates a patient working to lower their blood pressure
 */
function generateBloodPressureTrend() {
    const trend = [];
 ...
 * Seed cardiac health data
 */
async function seedCardiacHealth(options) {
 ...
 */
async function clearCardiacHealth(patientId) {
    const db = (0, firestore_1.getFirestore)();
    const cardiacHealthRef = db.collection('patients').doc(patientId).collection('cardiacHealth');
...
//# sourceMappingURL=seedCardiacHealth.js.map