...
exports.FOCUS_CONFIGS = void 0;
exports.getFocusConfig = getFocusConfig;
exports.getAllFocusIds = getAllFocusIds;
exports.getFocusDisplayInfo = getFocusDisplayInfo;
/**
 * All 10 nutrition focus configurations
 */
exports.FOCUS_CONFIGS = {
    // ═══════════════════════════════════════════════════════════════════
 ...
 */
function getFocusConfig(focusId) {
    var _a;
    return (_a = exports.FOCUS_CONFIGS[focusId]) !== null && _a !== void 0 ? _a : exports.FOCUS_CONFIGS.balanced;
}
/**
 * Get all available focus IDs
 */
function getAllFocusIds() {
    return Object.keys(exports.FOCUS_CONFIGS);
}
/**
 * Get focus display info for UI
 */
function getFocusDisplayInfo() {
    return Object.values(exports.FOCUS_CONFIGS).map(({ id, name, description }) => ({
        id,
        name,
        description,
    }));
}
//# sourceMappingURL=focusConfig.js.map