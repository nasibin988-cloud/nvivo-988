...
exports.DRI_TABLE = void 0;
exports.getDriDefinition = getDriDefinition;
exports.getDefinedNutrients = getDefinedNutrients;
/**
 ...
 */
function getDriDefinition(nutrientId) {
    return exports.DRI_TABLE[nutrientId];
}
/**
 ...
 */
function getDefinedNutrients() {
    return Object.keys(exports.DRI_TABLE);
}
//# sourceMappingURL=driTable.js.map