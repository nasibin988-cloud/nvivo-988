...
exports.comparatorOpenaiApiKey = void 0;
exports.compareFoods = compareFoods;
exports.compareFoodsWithInsights = compareFoodsWithInsights;
exports.getQuickWinner = getQuickWinner;
exports.compareTwo = compareTwo;
const openai_1 = __importDefault(require("openai"));
const params_1 = require("firebase-functions/params");
// Define secret for lazy access at runtime
const openaiApiKey = (0, params_1.defineSecret)('OPENAI_API_KEY');
exports.comparatorOpenaiApiKey = openaiApiKey;
 ...
 */
function compareFoods(foods, userFocus = 'balanced') {
    if (foods.length < 2) {
 ...
 */
async function compareFoodsWithInsights(foods, userFocus = 'balanced') {
 ...
 */
function determineFocusWinner(foods, focus) {
 ...
 */
function compareNutrients(foods) {
    const nutrients = [
 ...
 */
function isHigherBetter(nutrient) {
    const lowerIsBetter = [
 ...
 */
async function generateComparisonInsights(foods, comparison, userFocus) {
    var _a, _b;
 ...
 */
function buildInsightPrompt(foods, comparison, userFocus) {
 ...
 */
function getQuickWinner(foods, focus) {
 ...
 */
function compareTwo(foodA, foodB, focus) {
