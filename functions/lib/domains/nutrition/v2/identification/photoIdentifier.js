...
exports.photoIdOpenaiApiKey = void 0;
exports.identifyFoodsFromPhoto = identifyFoodsFromPhoto;
exports.identifyFoodsFromPhotoUrl = identifyFoodsFromPhotoUrl;
const openai_1 = __importDefault(require("openai"));
const params_1 = require("firebase-functions/params");
const openai_2 = require("../../../../config/openai");
// Define secret for lazy access at runtime
const openaiApiKey = (0, params_1.defineSecret)('OPENAI_API_KEY');
exports.photoIdOpenaiApiKey = openaiApiKey;
 ...
 */
async function identifyFoodsFromPhoto(imageBase64, mimeType = 'image/jpeg') {
    var _a, _b;
    try {
 ...
 */
function calculateImageConfidence(items) {
    if (items.length === 0)
        return 0;
 ...
 */
async function identifyFoodsFromPhotoUrl(imageUrl) {
    var _a, _b;
    try {
        const openai = getOpenAIClient();
        const response = await openai.chat.completions.create({
...
//# sourceMappingURL=photoIdentifier.js.map