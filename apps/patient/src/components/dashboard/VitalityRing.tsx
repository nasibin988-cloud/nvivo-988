...
function Variant5({
  ...
  const ringGap = 3;
  const rings = [
    { label: 'Mood', value: wellnessLog.mood, color: '#06B6D4', secondaryColor: '#22D3EE' }, // Cyan
    { label: 'Energy', value: wellnessLog.energy, color: '#10B981', secondaryColor: '#34D399' }, // Emerald
    { label: 'Sleep', value: wellnessLog.sleepQuality, color: '#8B5CF6', secondaryColor: '#A78BFA' }, // Purple
    { label: 'Calm', value: 11 - wellnessLog.stress, color: '#F59E0B', secondaryColor: '#FBBF24' }, // Amber (stress inverted)
  ];
